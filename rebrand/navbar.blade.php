<nav class="flex flex-col flex-1 bg-white border-r dark:border-coolgray-200 border-neutral-300 dark:bg-base"
    ...
    <div class="flex pt-4 pb-4 pl-2 pr-3 items-start gap-3"
        ...
        <div class="flex min-w-0 flex-1 flex-col" :class="collapsed && 'lg:hidden'">
            <a href="/" {{ wireNavigate() }} class="text-2xl font-bold tracking-tight dark:text-white hover:opacity-80 transition-opacity">Vultify</a>
            <x-version />
        </div>
        <div class="hidden flex-col items-center w-full gap-1"
            ...
            <a href="/" {{ wireNavigate() }}
                ...
                title="Vultify">
                <img src="/coolify-logo.svg" alt="Vultify" class="w-6 h-6" />
            </a>
        ...
        <li class="flex-1 overflow-x-hidden">
            <ul role="list" class="flex flex-col h-full space-y-1.5">
                @if (isSubscribed() || !isCloud())
                    ...
                    <li>
                        <a title="Ares AI" href="/ares" {{ wireNavigate() }}
                            class="{{ request()->is('ares') ? 'menu-item-active menu-item' : 'menu-item' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="menu-item-icon" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
                            </svg>
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">Ares AI</span>
                        </a>
                    </li>
                    <li>
                        <a title="System Logs" href="/logs" {{ wireNavigate() }}
                            class="{{ request()->is('logs') ? 'menu-item-active menu-item' : 'menu-item' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="menu-item-icon" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a title="Vultify.io" class="menu-item" href="https://vultify.io"
                            target="_blank">
                            <svg class="text-violet-400 menu-item-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <g fill="none" stroke="currentColor" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2">
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">Vultify.io</span>
                        </a>
                    </li>
                @endif
